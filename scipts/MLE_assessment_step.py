...
#%%
# df = pd.read_excel(f'{w_path}\\MLE_assesment_step.xlsx',header=0)
df = pd.DataFrame()
# import re
# pattern = r"'([A-Za-z]+\d*)'"
                ...
                for l_ in ['','L']:
                    for g_ in ['','G']:
                        for c_ in ['','C']:
                            ...
                            df.to_excel(f'{w_path}\\MLE_assesment_step.xlsx',header=True,index=False)
