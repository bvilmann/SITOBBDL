...
class PSEMT:
    ...
    def add_line(self, bus1, bus2, r, x, name=None, c=0):
        ...
        self.G.add_edge(bus1, bus2, z=z, y=1 / z, yc=1j * c * self.omega, t='line',
                        name=f'{name}' + ("\n", "")[name is None] + f'{z}')
    ...
    def add_transformer(self, bus1, bus2, r, x, n=1, alpha=0, name=None):
        ...
        self.G.add_edge(bus1, bus2, y=y, Y=Y, y12=Y[0, 1], y21=Y[1, 0], y11=Y[0, 0], y22=Y[1, 1], bus1=bus1, bus2=bus2,
                        t='transformer', name=name, alpha=alpha)
